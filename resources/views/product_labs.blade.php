    ...
    <div class="mb-16 max-w-5xl mx-auto">
      ...
      <div class="space-y-6 text-gray-700 leading-relaxed bg-white p-8 rounded-xl shadow-lg">
        <p class="text-base md:text-lg">
          <strong class="text-gray-900">SmartGarden.ID Labs</strong> hadir sebagai mitra terpercaya petani Indonesia 
        ...
        <p class="text-base md:text-lg">
          Dengan <strong class="text-gray-900">SmartGarden.ID Labs</strong>, petani dapat meningkatkan hasil panen 
