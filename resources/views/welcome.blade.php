...
<main>
    ...
    <section class="gj do ir hj sp jr i pg">
        ...
        <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
            ...
            <img src="images/foto_4.png" alt="Woman" class="h q r ua" />
        </div>
            ...
            <div class="tc _o">
                <div class="animate_left jn/2">
                    ...
                    <p class="fq">
                        ...
                        tropis berbasis data yang cerdas, efisien, dan berkelanjutan; dari irigasi pintar hingga panen
                        buah premium.
                    </p>
    ...
    <section class="ji gp uq 2xl:ud-py-35 pg">
        <div class="bb ze ki xn wq">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <!-- About Images -->
                <div class="animate_left order-2 lg:order-1">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                        <iframe class="w-full aspect-video"
                            src="https://www.youtube.com/embed/H44_aisnqos?si=W4wOxPdDyhdVovIq"
                ...
                <!-- About Content -->
                <div class="animate_right order-1 lg:order-2 space-y-4">
                    <h2 class="fk vj zp pr kk wm qb">Kenapa Memilih Kami</h2>
                    <p class="uo">
                        Kami mewujudkan ekosistem pertanian cerdas berbasis AI dan IoT untuk meningkatkan produktivitas,
                    ...
                    @forelse($beritas as $berita)
                        ...
                        <div class="swiper-slide">
                            <a href="{{ route('news.show', $berita->slug) }}" class="block group h-full">
                                <div
                                    class="bg-white rounded-2xl shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-1 h-full flex flex-col">
                                    <!-- Gambar dengan tinggi tetap -->
                                    <div class="w-full h-48 overflow-hidden">
                                        <img src="{{ $berita->gambar1_url }}" alt="{{ $berita->judul }}"
                                    ...
                                    <div class="p-5 flex flex-col flex-grow">
                                        <h3
                                            class="text-lg font-semibold text-gray-800 group-hover:text-green-600 transition-colors duration-300 line-clamp-2 min-h-[3.5rem]">
                                        ...
                                        <div class="mt-4 pt-3 border-t border-gray-100">
                                            <span
                                                class="inline-block bg-green-500 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors duration-300 group-hover:bg-green-600 w-full text-center">
                                                Baca Selengkapnya →
                                            </span>
                                        </div>
                                    </div>
                    ...
                    @empty
                        ...
                        <div class="swiper-slide">
                            <div class="bg-white rounded-2xl shadow-md overflow-hidden h-full flex flex-col">
                                <div class="w-full h-48 overflow-hidden">
                                    <img src="{{ asset('images/blog-default.png') }}" alt="Default Image"
                                        class="w-full h-full object-cover">
                                </div>
                                <div class="p-5 flex flex-col flex-grow">
                                    ...
                                    <div class="mt-4 pt-3 border-t border-gray-100">
                                        <span
                                            class="inline-block bg-gray-400 text-white text-sm font-medium px-4 py-2 rounded-md w-full text-center">
                                            Tidak Tersedia
                                        </span>
                                    </div>
                                </div>
