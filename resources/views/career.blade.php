                ...
                <div class="order-1 lg:order-2">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                        <iframe class="w-full aspect-video"
                            ...
                            title="SmartGarden.ID Career Video" frameborder="0"
                    ...
                    <div class="swiper internshipSwiper rounded-2xl overflow-hidden shadow-2xl">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="images/foto_4.png" alt="Team Working 1"
                                    class="w-full h-[400px] object-cover" />
                            </div>
                            <div class="swiper-slide">
                                <img src="images/foto_2.jpg" alt="Team Working 2"
                                    class="w-full h-[400px] object-cover" />
                            </div>
                            <div class="swiper-slide">
                                <img src="images/foto_3.png" alt="Team Working 3"
                                    class="w-full h-[400px] object-cover" />
                            </div>
                        </div>
